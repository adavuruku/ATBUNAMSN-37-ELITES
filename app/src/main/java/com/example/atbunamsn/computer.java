 ...
 */
public class computer extends Fragment implements SearchView.OnQueryTextListener{
   ...
   // public NetworkChangeReceiver receiver;
    SharedPreferences computerlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(),recyclerView , new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
               ...
               // int l = (int)(recyclerAdapter.getItemId(position));
                ...
                if(search=="searchresult") {
                    ...
                    userDept = arraylist.get(position).getDept();
                    userName = arraylist.get(position).getName();
                    userLevel = arraylist.get(position).getLevel();
                    userPics = arraylist.get(position).getBLOB();
                }
  ...
  /**  public class NetworkChangeReceiver extends BroadcastReceiver {
    ...
    public void volleyJsonArrayRequest(String url){
        String  REQUEST_TAG = "com.volley.volleyJsonArrayRequestComp";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("department", "Computer Science");
                return params;
            }
        };
    ...
    class loadValues extends AsyncTask<String, Integer, String >{
        ...
        protected void onPostExecute(String s) {
            ...
            connectionStatus.setVisibility(View.GONE);
            String stat = "online";
            recyclerAdapter = new recyclerAdapter(recyclerView, arraylist, getActivity(),stat);
...
//            pd.show();**/
        ...
        protected String doInBackground(String... strings) {
            ...
            //Cursor cursor = dbHelper.getOnly();
            Cursor cursor = dbHelper.getDetails(dbColumnList.userDetails.COLUMN_DEPT,dept);
            //Toast.makeText(getActivity(),String.valueOf(cursor.getCount()),Toast.LENGTH_SHORT);
