...
public class changeQoute extends AppCompatActivity {
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_qoute);
       ...
       bitmap = BitmapFactory.decodeByteArray(userPics,0,userPics.length);
        ...
        qoute = MyQoute.getString("MyQoute", "");
        prev.setText(qoute.trim());
        ...
        saveRecord.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(prev_p) && prev_p.length() < 10){

                    displayMessage("Error: Invalid / Empty Qoutes Provided Or Qoute Size is Less than 10 Characters  !!" + System.getProperty("line.separator") + "Please Verify !");
                }
                else
                {
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent = new Intent(changeQoute.this, homeView.class);
            startActivity(intent);
    ...
    public void localUpdateQoute() {
        dbHelper.updateForAll(dbColumnList.userDetails.TABLE_NAME, dbColumnList.userDetails.COLUMN_QOUTE, prev_p,
                dbColumnList.userBest.COLUMN_USERID, userID);
        Toast.makeText(changeQoute.this, "Your Qoute was Successfully Updated / Change !!", Toast.LENGTH_LONG).show();
        SharedPreferences.Editor editor;

        editor = MyQoute.edit();
        editor.putString("MyQoute", prev_p);
        editor.apply();
        dbHelper = new dbHelper(this);
        Intent intent = new Intent(changeQoute.this, homeView.class);
        startActivity(intent);
    ...
    public void volleyJsonArrayRequest(String url){
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("opr", "changeQoute");
                params.put("newQoute", prev_p);
    ...
    public void initNavigationDrawer() {
        ...
        imageV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog d = new Dialog(changeQoute.this);
